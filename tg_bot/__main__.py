...
TECHNO_IMG = "https://telegra.ph/file/d9fede15ec976bab3743d.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Ashnor_love_delhi")],
                                                                                   [InlineKeyboardButton(text="ADD 𝙽𝙴𝙴𝚃 𝙰𝙸𝙸𝙼𝚂 & 𝙹𝙴𝙴 𝙾𝙵𝙵𝙸𝙲𝙰𝙻 BOT TO YOUR GROUP",
        ...
        update.effective_message.reply_text("I'm here because of Dr.Himanshu💖")
